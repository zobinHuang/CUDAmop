...
int main(){
    ...
    int NUM_BLOCKS =  (32 * num_row) % NUM_THREADS_PER_BLOCK == 0 ?
                        (32 * num_row) / NUM_THREADS_PER_BLOCK :
                        (32 * num_row) / NUM_THREADS_PER_BLOCK + 1;
    ...
    CSRSpMVVector<<<NUM_BLOCKS, NUM_THREADS_PER_BLOCK>>>(num_row, d_col_ids, d_row_ptr, d_data, d_x, d_y);
    PROFILE(
